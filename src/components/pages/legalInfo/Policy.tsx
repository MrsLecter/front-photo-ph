    ...
    <>
      ...
      <WrapperInfo>
        ...
        <p>
          ...
          FOM Online, Inc. (&ldquo;PhotoDrop,&rdquo; &ldquo;us,&rdquo;
          &ldquo;we,&rdquo; or &ldquo;our&rdquo;) website available at
          photodrop.me and the PhotoDrop photo finding service (together, the
          &ldquo;Service&rdquo;) are owned and operated by PhotoDrop. This
          Privacy Policy does not apply to any third party websites, services or
          applications, even if they are accessible through our Service. Also,
          please note that, unless we define a term in this Privacy Policy, all
          capitalized terms used in this Privacy Policy have the same meanings
          as in our Terms of Service. So, please make sure that you have read
        ...
        <p>
          ...
          than the laws in your country. If you&rsquo;re located outside the
          United States and choose to provide your Personal Information to us,
          we may transfer your Personal Information to the United States and
          process it there.
        </p>
        ...
        <p>
          ...
          user is under 13, we will take steps to remove that user&rsquo;s
          Personal Information from our databases. We recommend that children
          between the ages of 13 and 18 obtain their parent&rsquo;s permission
          before submitting information over the internet. By using the Service,
          you are representing that you are at least 18 years old, or that you
          are at least 13 years old and have your parents&rsquo; permission to
          use the Service.
        </p>
        ...
        <p>
          ...
          such as your name, email address, and phone number (&ldquo;Personal
          Information&rdquo;) that you submit to us voluntarily through the
          Service, including Personal information that you submit in the process
          of creating or editing your Account and user profile on the Service.
          For example, our registration and login process requires you to
          provide us with your name, mobile phone number, valid email address
        ...
        <p>
          ...
          demographic information. We refer to such information as
          &ldquo;Anonymous Information&rdquo; because it cannot be used by
          itself to identify you and therefore is not Personal Information. We
          collect information in the form of the User Content that you submit
          during your use of the Service, such as photos, comments, ratings and
        ...
        <h4>Use of Facial Recognition Data</h4>
        <p>
        ...
        <p>
          ...
          accessing your mobile device&rsquo;s GPS coordinates or coarse
          location if you enable location services on your device. We may use
          location information to improve and personalize our Service for you,
          such as to identify photos of you near a particular location. If you
          do not want us to collect location information, you may disable that
          feature on your mobile device. However, if you disable the location
          services feature on your mobile device after using the App, we cannot
        ...
        <h4>E-mail and Email Addresses</h4>
        <p>
          <br />
          If you send an e-mail to us, or fill out our &ldquo;Feedback&rdquo;
          form through the Service, we will collect your e-mail address and the
          full content of your e-mail, including attached files, and other
          information you provide. We may use and display your full name and
          email address when you send an email notification to a friend through
          the Service or the social network from which you have connected to the
          Service (such as in an invitation, or when sharing your content).
          Additionally, we use your email address to contact you on behalf of
          your friends (such as when someone sends you a personal message) or
          notifications from a social network or other website with whom you
          have registered to receive such notifications. We may use this e-mail
          address to contact you, for things such as notifications of limited
          edition shop sales and other related information. You may indicate
          your preference to stop receiving further promotional communications
        ...
        <p>
          ...
          service providers&rsquo; server logs, including your Internet protocol
        ...
        <p>
          An &ldquo;Internet protocol address&rdquo; or &ldquo;IP Address&rdquo;
          is a number that is automatically assigned to your computer when you
          use the Internet. In some cases your IP Address stays the same from
          browser session to browser session; but if you use a consumer internet
          access provider, your IP Address probably varies from session to
          session. For example, we, or our service providers, may track your IP
          Address when you access the Service to assist with ad targeting.
        </p>
        <p>
          &ldquo;Cookies&rdquo; are small pieces of information that a website
          sends to your computer&rsquo;s hard drive while you are viewing a
          website. We may use both session Cookies (which expire once you close
          your web browser) and persistent Cookies (which stay on your computer
          until you delete them) to tell us how and when you interact with our
          Services, to monitor aggregate usage and web traffic routing on our
          Service, to improve our Service, and to provide you with a more
          personal and interactive experience with the Service. Persistent
          Cookies can be removed by following your Internet browser help file
          directions. In order to use our Service, your web browser must accept
          Cookies. If you choose to disable Cookies, some aspects or features of
          the Service may not work properly, and you will not be able to receive
          our Service.
        </p>
        <p>
          ...
          These advertisers and ad servers may use Cookies and/or &ldquo;Web
          Beacons&rdquo; (which are usually small, transparent graphic images).
          Web Beacons are used in order to deliver or communicate Cookies, to
          track and measure the performance of our Service, to monitor how many
          visitors view our Service, and to monitor information related to the
          effectiveness of served advertisements. Clicking on such
          advertisements will direct you to the website of a third-party and the
          advertiser. This Privacy Policy covers only our use of Cookies and Web
          Beacons and does not cover the use of Cookies, Web Beacons, and other
        ...
        <h4>The Ability of others to View your Information</h4>
        <p>
          <br />
        ...
        <h4>Responding to Do Not Track Signals</h4>
        <p>
          <br />
          Our website does not have the capability to respond to &ldquo;Do Not
          Track&rdquo; signals received from various web browsers.
        </p>
        <h4>Third Party Sites and Advertising</h4>
        <p>
          <br />
          ...
          or service and is subject to the owner&rsquo;s or operator&rsquo;s
          privacy policy. We encourage our users to read the privacy statements
          of each and every website they visit and service they use. This
          Privacy Policy applies solely to information collected by us through
          the Service and does not apply to these third-party websites. The
          ability to access information of third-parties from the Service, or
          links to other websites or locations, is for your convenience and does
          not signify our endorsement of such third-parties, their products,
        ...
        <p>
          ...
          the opportunity to &ldquo;opt-out&rdquo; by following the unsubscribe
          instructions provided in the promotional e-mail you receive or by
        ...
        <p>
          ...
          alert on this page and we&rsquo;ll update the &ldquo;Last Updated
          Date&rdquo; above to indicate when those changes will become
          effective. If you object to any such changes, you must cease using the
          Service. Continued use of the Service following notice of any such
